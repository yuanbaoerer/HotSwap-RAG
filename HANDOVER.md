...
| 文件位置 | 功能 | 实现说明 |
|----------|------|----------|
| `frontend/pages/3_Knowledge_Bases.py` | 知识库管理 | ✅ 连接API，支持CRUD操作 |
| `frontend/pages/2_Chat.py` | 问答功能 | ✅ 调用chat API，支持流式输出和引用来源 |
| `frontend/pages/1_Documents.py` | 文档管理 | ✅ 导出索引、清空所有文档已实现 |
| `frontend/pages/4_Settings.py` | 系统设置 | ✅ 连接配置API |
